...
#pragma warning restore 162
  ...
  /*
            // Still doesn't work due to some color space issue?          
#if PC_HDRP_10_OR_NEWER
            if (!cam.TryGetComponent(out UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData hdAdditionalCameraData))
            {
                hdAdditionalCameraData = cam.gameObject.AddComponent<UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData>();
            }

            hdAdditionalCameraData.clearColorMode = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.ClearColorMode.Color;
            hdAdditionalCameraData.backgroundColorHDR = Color.black;
            hdAdditionalCameraData.antialiasing = UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData.AntialiasingMode.None;
