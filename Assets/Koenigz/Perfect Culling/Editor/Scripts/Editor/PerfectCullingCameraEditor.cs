...
namespace Koenigz.PerfectCulling
{
    ...
    {
        private const string EditorPrefVisualizeFrustumCulling = "PC_VISUALIZE_FRUSTUM_CULLING";
        
        private static bool VisualizeFrustumCullingEditorPreference
        {
            get => EditorPrefs.GetBool(EditorPrefVisualizeFrustumCulling, true);
            set => EditorPrefs.SetBool(EditorPrefVisualizeFrustumCulling, value);
        }
        ...
        void Utility(PerfectCullingCamera camera)
        {
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                GUI.enabled = Application.isPlaying;
                {
                    ...
                    VisualizeFrustumCullingEditorPreference = GUILayout.Toggle(VisualizeFrustumCullingEditorPreference, " Visualize Frustum Culling");
                    
                    camera.VisualizeFrustumCulling = VisualizeFrustumCullingEditorPreference;
